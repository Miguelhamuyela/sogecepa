...
*/
        ...
        wb = function(a) {
            if ("string" !== typeof a || !a || -1 == a.search(ub))
                throw Error("p");
            if (!vb || "goog" != vb.type)
                throw Error("q`" + a);
            if (vb.uk)
        ...
        _.xd = function(a, b) {
            if ("textContent"in a)
                ...
                _.vd(a),
                a.appendChild(_.kd(a).createTextNode(String(b)))
        }
        ;
        _.jd = function(a) {
        ...
        ;
        _.jd.prototype.Qf = _.vd;
        _.jd.prototype.contains = _.wd;
        _.jd.prototype.dd = _.xd;
        var zd = function() {
            this.id = "b"
        };
        ...
        _.Dd = function(a, b) {
            ...
            if (a) {
                ...
                this.screenY = d.screenY || 0) : (this.offsetX = _.sc || void 0 !== a.offsetX ? a.offsetX : a.layerX,
        ...
        Jd.prototype.add = function(a, b, c, d, e) {
            ...
            var g = Kd(a, b, d, e);
            -1 < g ? (b = a[g],
            c || (b.Ud = !1)) : (b = new Hd(b,this.src,f,!!d,e),
            b.Ud = c,
            a.push(b));
            return b
        }
        ...
        ;
        Jd.prototype.wd = function(a, b, c, d) {
            a = this.g[a.toString()];
            var e = -1;
            a && (e = Kd(a, b, c, d));
            return -1 < e ? a[e] : null
        ...
        var Kd = function(a, b, c, d) {
            for (var e = 0; e < a.length; ++e) {
                var f = a[e];
                if (!f.Ed && f.listener == b && f.capture == !!c && f.me == d)
                    return e
            }
            return -1
        };
        ...
        _.Xd = function(a, b, c, d, e) {
            if (Array.isArray(b))
                ...
                c = Rd(c),
                _.Fd(a) ? a.vb(b, c, d, e) : a && (a = _.Td(a)) && (b = a.wd(b, c, d, e)) && _.Yd(b)
        }
        ;
        _.Yd = function(a) {
            if ("number" === typeof a || !a || a.Ed)
                return !1;
            var b = a.src;
            if (_.Fd(b))
                return Ld(b.fb, a);
        ...
        ;
        var ke, le = !1, ne = new he, pe = function(a, b) {
            ke || oe();
            le || (ke(),
            le = !0);
            ne.add(a, b)
            ...
            if (_.t.Promise && _.t.Promise.resolve) {
                ...
                ke = function() {
                    var b = qe;
                    "function" !== typeof _.t.setImmediate || _.t.Window && _.t.Window.prototype && (_.Da() || !_.v("Edge")) && _.t.Window.prototype.setImmediate == _.t.setImmediate ? (fe || (fe = ge()),
                    fe(b)) : _.t.setImmediate(b)
                }
        }, qe = function() {
...
*/
            ...
            if (!(this instanceof Ye))
                ...
                for (var c = [], d = 0; d < a.length; d++) {
                    ...
                    if (e[1]) {
                        ...
                        e = [];
                    c.push(f);
                    this.g[f] ? (f = this.g[f].h,
                    f != e && f.splice.apply(f, [0, f.length].concat(_.gb(e)))) : this.g[f] = new Wb(e,f)
                }
                b && b.length ? (wa(this.l, b),
                this.I = b[b.length - 1]) : this.H.g || this.H.callback();
                $e(this)
            }
        }
        ;
        ...
        var bf = function(a) {
            var b = a.U
              , c = a.isActive();
            c != b && (af(a, c ? "active" : "idle"),
            a.U = c);
            b = a.uh();
            b != a.W && (af(a, b ? "userActive" : "userIdle"),
            a.W = b)
        }
          , ef = function(a, b, c) {
            var d = [];
            ...
            for (var e = {}, f = 0; f < d.length; f++) {
                ...
                var l = new Ie;
                e[g] = l;
                h.g ? l.callback(a.Da) : (cf(a, g, h, !!c, l),
                df(a, g) || b.push(g))
            }
            0 < b.length && (0 === a.l.length ? a.O(b) : (a.h.push(b),
            bf(a)));
            return e
        }
          , cf = function(a, b, c, d, e) {
            ...
            df(a, b) ? d && (_.u(a.A, b) || a.A.push(b),
            bf(a)) : d && (_.u(a.A, b) || a.A.push(b))
        };
        Ye.prototype.O = function(a, b, c) {
            ...
            if (0 !== e.length) {
                ...
                if (0 < Object.keys(this.s).length && !this.B.M)
                    throw Error("H");
                a = (0,
                _.A)(this.B.H, this.B, _.va(e), this.g, {
                    dj: this.s,
                    hj: !!c,
                    Lf: function(f) {
                        var g = d.o;
                        ...
                        401 == f ? (gf(d, new wb.Za(wb.Za.g.Cg,f)),
                        d.h.length = 0) : 410 == f ? (hf(d, new wb.Za(wb.Za.g.Ag,f)),
                        jf(d)) : 3 <= d.F ? (hf(d, new wb.Za(wb.Za.g.qg,f)),
                        jf(d)) : d.O(d.o, !0, 8001 == f)
                    },
                    Fk: (0,
                    _.A)(this.ga, this)
                });
        ...
        var ff = function(a, b) {
            ...
            for (var c = [], d = 0; d < b.length; d++)
                c = c.concat(kf(a, b[d]));
            za(c);
            return !a.M && 1 < c.length ? (b = c.shift(),
          ...
          , $e = function(a) {
            a.j == a.D && (a.j = null,
            a.D.onLoad((0,
            _.A)(a.Yg, a)) && gf(a, new wb.Za(wb.Za.g.Ne)),
            bf(a))
        }
          , oa = function(a) {
            if (a.j) {
        ...
        var ma = function(a) {
            var b = _.ha;
            b.j && "synthetic_module_overhead" === b.j.gb() && (oa(b),
        ...
        Ye.prototype.Sh = function(a) {
            this.j || (this.g.synthetic_module_overhead = new Wb([],"synthetic_module_overhead"),
        ...
        _.uf.prototype.delete = function(a) {
            return zf(this.h, a) ? (delete this.h[a],
            --this.size,
            this.j++,
        ...
        ;
        _.k.keys = function() {
            return tf(this.Yb(!0)).h()
        }
        ;
        _.k.values = function() {
            return tf(this.Yb(!1)).h()
        }
        ;
        ...
        var If = function(a, b) {
            ...
            return Ff(a, function(d) {
                ...
                if (e.contains && "function" == typeof e.contains)
                    d = e.contains(d);
                else if (e.pd && "function" == typeof e.pd)
                    d = e.pd(d);
                else if (_.ea(e) || "string" === typeof e)
                    d = _.u(e, d);
                else
                    a: {
                        for (var f in e)
        ...
        new E("Bgf0ib");
        var Lf = new E("MpJwZc","MpJwZc");
        _.Mf = new E("UUJqVe","UUJqVe");
        _.Nf = new E("GHAeAc","GHAeAc");
        _.Of = new E("Wt6vjf","Wt6vjf");
        _.Pf = new E("byfTOb","byfTOb");
        _.Qf = new E("LEikZe","LEikZe");
        _.Rf = new E("lsjVmc","lsjVmc");
        new E("pVbxBc");
        new E("klpyYe");
        new E("OPbIxb");
        new E("pg9hFd");
        ...
        _.$f = function(a) {
            ...
            _.dg(this, a.j),
            eg(this, fg(a.g)),
            this.s = a.s) : a && (b = String(a).match(_.Wf)) ? (this.o = !1,
            _.ag(this, b[1] || "", !0),
            this.A = gg(b[2] || ""),
            _.bg(this, b[3] || "", !0),
            cg(this, b[4]),
            _.dg(this, b[5] || "", !0),
            eg(this, b[6] || "", !0),
            this.s = gg(b[7] || "")) : (this.o = !1,
            this.g = new _.hg(null,this.o))
        }
        ;
        ...
        ;
        eg = function(a, b, c) {
            b instanceof _.hg ? (a.g = b,
            ng(a.g, a.o)) : (c || (b = ig(b, og)),
            a.g = new _.hg(b,a.o))
        }
        ;
        _.pg = function(a) {
        ...
        ;
        ig = function(a, b, c) {
            return "string" === typeof a ? (a = encodeURI(a).replace(b, qg),
        ...
        var wg = "ARTICLE SECTION NAV ASIDE H1 H2 H3 H4 H5 H6 HEADER FOOTER ADDRESS P HR PRE BLOCKQUOTE OL UL LH LI DL DT DD FIGURE FIGCAPTION MAIN DIV EM STRONG SMALL S CITE Q DFN ABBR RUBY RB RT RTC RP DATA TIME CODE VAR SAMP KBD SUB SUP I B U MARK BDI BDO SPAN BR WBR INS DEL PICTURE PARAM TRACK MAP TABLE CAPTION COLGROUP COL TBODY THEAD TFOOT TR TD TH SELECT DATALIST OPTGROUP OPTION OUTPUT PROGRESS METER FIELDSET LEGEND DETAILS SUMMARY MENU DIALOG SLOT CANVAS FONT CENTER ACRONYM BASEFONT BIG DIR HGROUP STRIKE TT".split(" ")
          , xg = [["A", new Map([["href", {
            Ca: 2
        }]])], ["AREA", new Map([["href", {
            Ca: 2
          ...
          , yg = "title aria-atomic aria-autocomplete aria-busy aria-checked aria-current aria-disabled aria-dropeffect aria-expanded aria-haspopup aria-hidden aria-invalid aria-label aria-level aria-live aria-multiline aria-multiselectable aria-orientation aria-posinset aria-pressed aria-readonly aria-relevant aria-required aria-selected aria-setsize aria-sort aria-valuemax aria-valuemin aria-valuenow aria-valuetext alt align autocapitalize autocomplete autocorrect autofocus autoplay bgcolor border cellpadding cellspacing checked color cols colspan controls datetime disabled download draggable enctype face formenctype frameborder height hreflang hidden ismap label lang loop max maxlength media minlength min multiple muted nonce open placeholder preload rel required reversed role rows rowspan selected shape size sizes slot span spellcheck start step summary translate type valign value width wrap itemscope itemtype itemid itemprop itemref".split(" ")
          , zg = [["dir", {
            Ca: 3,
        ...
        (new Set(Ra(function() {
            return wg.concat("STYLE TITLE INPUT TEXTAREA BUTTON LABEL".split(" "))
        })),new Set(Ra(function() {
            return yg.concat(["class", "id", "tabindex", "contenteditable", "name"])
        })),new Map(Ra(function() {
            return zg.concat([["style", {
                Ca: 4
            }]])
        })));
        var Bg;
        ...
        ;
        _.Dg = [Wa("data"), Wa("http"), Wa("https"), Wa("mailto"), Wa("ftp"), new _.Va(function(a) {
            return /^[^:]*([/?#]|$)/.test(a)
        }
        )];
        _.Eg = function(a, b) {
        ...
        ;
        _.Eg.prototype.Oa = function(a) {
            a = a({}, this.j ? this.j.g() : {});
            this.h(null, "function" == typeof _.Fg && a instanceof _.Fg ? a.Kb : null)
        }
        ;
        _.Eg.prototype.h = function() {}
        ;
        var Gg = function(a) {
            this.h = a;
        ...
        Gg.prototype.g = function() {
            this.h.Bb() || (this.j = this.h.g(_.Mf));
            return this.j ? this.j.l() : {}
        }
        ;
        var Hg = function(a) {
            var b = new Gg(a);
            _.Eg.call(this, b, a.get(_.ac).h);
            this.l = new _.H;
            this.o = b
        };
        _.y(Hg, _.Eg);
        ...
        ;
        Hg.prototype.h = function(a, b) {
            _.Eg.prototype.h.call(this, a, b);
        ...
        Lg.prototype.toString = function() {
            if (this.h.endsWith("_/wa/"))
                var a = this.l ? this.h + Mg(this, "wk") + "/" + this.l : this.h + Mg(this, "wk") + ".wasm";
            else {
                a = this.h + Ng(this);
                var b = this.j;
                var c = [], d;
        ...
        var Og = function(a) {
          ...
          , Ug = function(a) {
            ...
            if (d.h.endsWith("_/wa/"))
                return b = Tg(a),
                a.endsWith(".wasm") || (a = a.split("/"),
                d.l = a[a.length - 1]),
                Pg(d, "wk", b.toString()),
                d;
            if (!b)
                return d;
            (a = c.match(_.Wf)[6] || null) && Yf(a, function(g, h) {
                d.j[g] = h
            });
            return d
        }
          , Tg = function(a) {
            ...
            try {
                var d = a.split(".");
                var e = 4 !== d.length && 3 !== d.length || -1 !== d[0].indexOf("=") ? null : new Kg(d);
                if (null === e)
        ...
        _.B(_.Vg, _.D);
        var Wg = [];
        _.Vg.prototype.J = function(a, b, c, d) {
            return Xg(this, a, b, c, d)
        }
        ;
        var Xg = function(a, b, c, d, e, f) {
            Array.isArray(c) || (c && (Wg[0] = c.toString()),
            c = Wg);
        ...
        _.Vg.prototype.dc = function(a, b, c, d) {
        ...
        _.Vg.prototype.vb = function(a, b, c, d, e) {
            if (Array.isArray(b))
                for (var f = 0; f < b.length; f++)
                    this.vb(a, b[f], c, d, e);
            else
                ...
                c = Rd(c),
                d = !!d,
                b = _.Fd(a) ? a.wd(b, c, d, e) : a ? (a = _.Td(a)) ? a.wd(b, c, d, e) : null : null,
                b && (_.Yd(b),
                delete this.g[b.key]);
            return this
        }
        ...
        ;
        _.Vg.prototype.K = function() {
            _.Vg.R.K.call(this);
            _.Zg(this)
        }
        ;
        _.Vg.prototype.handleEvent = function() {
            throw Error("R");
        }
        ;
        var $g = function() {};
        ...
        _.ih.prototype.send = function(a, b, c, d) {
            ...
            try {
                nh(this),
                0 < this.o && ((this.I = oh(this.g)) ? (this.g.timeout = this.o,
                this.g.ontimeout = (0,
                _.A)(this.U, this)) : this.B = _.hh(this.U, this.o, this)),
                this.A = !0,
                this.g.send(a),
                this.A = !1
            } catch (g) {
        ...
        _.ih.prototype.U = function() {
            "undefined" != typeof sb && this.g && (this.l = 8,
        ...
        ;
        var rh = function(a) {
            if (a.h && "undefined" != typeof sb && (!a.F[1] || 4 != _.sh(a) || 2 != a.hb()))
                if (a.A && 4 == _.sh(a))
                    _.hh(a.V, 0, a);
        ...
        _.ih.prototype.yd = function() {
            ...
            if (!b) {
                if (a = 0 === a)
                    a = String(this.s).match(_.Wf)[1] || null,
        ...
        var Ah = function(a, b, c, d) {
            d = void 0 === d ? !1 : d;
            var e = _.Xf(a.F.match(_.Wf)[3] || null);
            ...
            if (d && 0 == a.lastIndexOf("/", 0)) {
                e = document.location.href.match(_.Wf);
                d = e[1];
                b = e[2];
                c = e[3];
                e = e[4];
          ...
          , Gh = function(a) {
            var b = _.Xf(a.match(_.Wf)[5] || null) || ""
              , c = _.Xf(Rg(b).match(_.Wf)[5] || null);
            return (null === c ? 0 : RegExp("/_/wa/", "g").test(c) ? Tg(b) : RegExp("(/_/js/)|(/_/ss/)", "g").test(c) && /\/k=/.test(c)) ? a : null
        }
          , Dh = function() {
            this.g = new Ie;
            this.nb = this.o = "";
    ...
    try {
        ...
        _.L[42] = "Tradutor";
        _.L[43] = "Traduzir";
        _.L[44] = "Sua corre\u00e7\u00e3o foi enviada.";
...
//# sourceURL=/_/translate_http/_/js/k=translate_http.tr.pt_BR.kZT1xGEoiHU.O/am=CAM/d=1/rs=AN8SPfqdMzNYcjVdxSop6nKGEYp_Y5G4Vw/m=el_conf
// Configure Constants
(function() {
    ...
    (function() {
        ...
        c._cnal = {};
        _loadCss(c._ps);
        _loadJs('https:\/\/translate.googleapis.com\/_\/translate_http\/_\/js\/k\x3dtranslate_http.tr.pt_BR.kZT1xGEoiHU.O\/d\x3d1\/exm\x3del_conf\/ed\x3d1\/rs\x3dAN8SPfpB3ft1qnC1Vckx3BV1BZkR7V3clQ\/m\x3del_main');
        _exportMessages();
        _exportVersion('TE_20231030');
    }
    )();
}
)();
