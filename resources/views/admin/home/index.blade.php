    ...
    <div class="card mb-2">
        <div class="card-body">
            <h2 class="h5 page-title">
                Portal Angola Hoje - <b>Portal de Informação Económica e Financeira</b> <br>
            ...
            <div class="card shadow bg-primary text-white">
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col pr-0">
                            <p class="small text-light mb-0">Eventos</p>
                            <span class="h3 mb-0 text-white">{{ $count_event }}</span>
                        </div>
                    </div>
                </div>
            </div>
