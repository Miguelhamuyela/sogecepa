            ...
            <div class="financity-page-title-wrap  financity-style-custom financity-left-align">
                ...
                <div class="financity-page-title-container financity-container">
                    <div class="financity-page-title-content financity-item-pdlr">
                        <h1 class="financity-page-title">Digital.ao</h1>
                    ...
                    <div class="gdlr-core-pbf-element">
                        <div class="gdlr-core-breadcrumbs-item gdlr-core-item-pdlr gdlr-core-item-pdb "> <span
                                ...
                                <meta property="position" content="1">
                                    ...
                                    href="{{ route('site.digitalAo') }}" class="post post-page"><span
                                        property="name">Digital.ao</span></a>
            ...
            <div class="row my-5 flex-column-reverse flex-lg-row">
                ...
                <div class="col-md-8 col-12 container ">
                    ...
                    <p style="text-align: justify;">
                        A incubadora de empresas do Digital.AO é uma instituição cujo objectivo é preparar,
                        fortalecer e dar suporte à micro e pequenas empresas em estágio inicial para que elas sobrevivam no
                        mercado.
                        ...
                        A incubadora referenciada neste termo oferece serviços de gestão empresari- al, suporte
                        técnico e formações complementares para os empreendedores. Isso é feito por meio de um
                        espaço físico estruturado com salas de reunião, internet e acesso a ferramentas e
                        equipamentos que são oferecidos à novas empresas.

                        <br>
                        <br>

                        Apesar do processo ainda ser relativamente novo em Angola, a incubadora de empresas do Digital.AO
                        pode ajudar os novos negócios a conseguirem parcerias, cursos de capacitação, consultoria com
                        especialistas
                        e uma infinidade de outros benefícios.
                    </p>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid" id="img-digitalAo" src="/site/assets/upload/digital1.jpeg"
                                    alt="">

                            </div>

                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid" id="img-digitalAo" src="/site/assets/upload/digital3.jpeg"
                                    alt="">
