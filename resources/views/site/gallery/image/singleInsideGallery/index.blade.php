            ...
            <div class="financity-page-title-wrap  financity-style-custom financity-left-align">
                ...
                <div class="financity-page-title-container financity-container">
                    <div class="financity-page-title-content financity-item-pdlr">
                        <h1 class="financity-page-title">{{ $insideGallery->category }}</h1>
                            ...
                            •<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage"
                                ...
                                <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage"
                                        title="Go to Our Services." href="#" class="post post-page"><span
                                            property="name">{{ $insideGallery->category }}</span></a>
                                    ...
                                    <div class="gdlr-core-item-list gdlr-core-gallery-column  gdlr-core-column-20">
                                        <div class="gdlr-core-gallery-list gdlr-core-media-image">
                                            <a class="gdlr-core-ilightbox gdlr-core-js "
                                                ...
                                                data-ilightbox-group="gdlr-core-img-group-2"
                                                data-caption="{{ $item->title }} {{ $item->description }}"><img
                                                    src="/storage/{{ $item->path }}" alt=""
                                                    id="card-img-angola-hoje"><span class="gdlr-core-image-overlay ">
                                                    <p style="margin-top:100px;">{{ $item->title }}</p>
                                                </span> </a>
                                        </div>
                                    </div>
                                @endforeach
