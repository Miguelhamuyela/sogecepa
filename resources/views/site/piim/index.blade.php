...
@section('titulo', ' Plano Integrado de Intervenção nos Municípios (PIIM)')
@section('content')
    <!-- ====== Banner Start ====== -->
            ...
            <div class="financity-page-title-wrap  financity-style-custom financity-left-align">
                ...
                <div class="financity-page-title-container financity-container">
                    <div class="financity-page-title-content financity-item-pdlr">
                        <h1 class="financity-page-title">Plano Integrado de Intervenção nos Municípios (PIIM)</h1>
                ...
                <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                    <div class="gdlr-core-pbf-element">
                        <div class="gdlr-core-breadcrumbs-item gdlr-core-item-pdlr gdlr-core-item-pdb "> <span
                            ...
                            •<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage"
                                    href="{{ route('site.piim') }}" class="post post-page"><span property="name">Plano
                                        Integrado de Intervenção nos Municípios (PIIM)</span></a>
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <p style="text-align: justify;">
                                ...
                                O Plano Integrado de Intervenção nos Municípios (PIIM) tem como objectivo materializar
                                acções de
                                Investimento Públicos (PIP), de Despesas de Apoio ao Desenvolvimento (DAD) e de Actividades
                                Básicas (Act),
                                com prioridade para as acções de carácter social, de modo a inibir o êxodo rural e promover
                                o crescimento
                                económico, social e regional mais inclusivo no País.

                                <br>
                                <br>

                                Este Plano pretende aumentar a autonomia dos 164
                                municípios de Angola no âmbito da política de desconcentração e descentralização das
                                competências
                                administrativas e, deste modo, aumentar a qualidade de vida em todo o território nacional.


                            </p>

                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid" id="img-digitalAo" src="/site/assets/upload/piim_1.jpeg"
                                    alt="">

                            </div>

                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid" id="img-digitalAo" src="/site/assets/upload/piim_2.jpeg"
                                    alt="">
                            ...
                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid" id="img-digitalAo" src="/site/assets/upload/piim_3.jpeg"
                                    alt="">

                            </div>

                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid" id="img-digitalAo" src="/site/assets/upload/piim_4.jpeg"
                                    alt="">
