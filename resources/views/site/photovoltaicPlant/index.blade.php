...
@section('titulo', ' Centrais Fotovoltaica do Biópio e Baía Farta')
@section('content')
    <!-- ====== Banner Start ====== -->
            ...
            <div class="financity-page-title-wrap  financity-style-custom financity-left-align">
                ...
                <div class="financity-page-title-container financity-container">
                    <div class="financity-page-title-content financity-item-pdlr">
                        <h1 class="financity-page-title">Centrais Fotovoltaica do Biópio e Baía Farta</h1>
                ...
                <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                    <div class="gdlr-core-pbf-element">
                        <div class="gdlr-core-breadcrumbs-item gdlr-core-item-pdlr gdlr-core-item-pdb "> <span
                            ...
                            •<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage"
                                    href="{{ route('site.photovoltaicPlant') }}" class="post post-page"><span
                                        property="name">Centrais Fotovoltaica do Biópio e Baía Farta</span></a>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="row my-5 flex-column-reverse flex-lg-row">
                ...
                <div class="col-md-8 col-12 container ">
                    ...
                    <div style="text-align: justify;">
                        ...
                        {!! html_entity_decode($photovoltaic->body) !!}
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid" id="img-digitalAo" src="/site/assets/upload/usina-01.jpeg"
                                    alt="">

                            </div>

                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid" id="img-digitalAo" src="/site/assets/upload/usina-02.jpg"
                                    alt="">
                            ...
                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid" id="img-digitalAo" src="/site/assets/upload/usina-03.jpg"
                                    alt="">

                            </div>

                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid" id="img-digitalAo" src="/site/assets/upload/usina-04.jpg"
                                    alt="">
