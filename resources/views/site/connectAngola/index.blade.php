            ...
            <div class="financity-page-title-wrap  financity-style-custom financity-left-align">
                ...
                <div class="financity-page-title-container financity-container">
                    <div class="financity-page-title-content financity-item-pdlr">
                        <h1 class="financity-page-title">Conecta Angola</h1>
            ...
            <div class="container">
                ...
                <div class="row my-5 flex-column-reverse flex-lg-row">
                    ...
                    <div class="col-md-8 col-12 container">
                        ...
                        <p>
                            Conecta Angola é um projecto de âmbito social que teve o seu lançamento no dia 12 de Junho,
                            durante a abertura oficial do ANGOTIC 2023, fruto da capacidade espacial do satélite ANGOSAT-2,
                            cuja
                            zona de cobertura permite alcançar as regiões mais recônditas do país, que no passado não tinham
                            qualquer rede de comunicação.

                            <br>
                            <br>

                            O projecto é uma parceria entre a INFRASAT, GGPEN e a ANGOLA TELECOM, com as primeiras
                            instalações feitas
                            nas províncias do Bié e Moxico. Contudo, o objectivo é alcançar todo o país num futuro próximo.
                            <br><br>

                            O Conecta Angola, usando o ANGOSAT-2, já é uma realidade.
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid rounded" src="/site/assets/upload/conecta_angola.jpeg" alt="">

                            </div>


                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid rounded" src="/site/assets/upload/angola-conecta.jpg" alt="">

                            </div>

                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid rounded" src="/site/assets/upload/angola-conecta-3.jpg"
                                    alt="">
