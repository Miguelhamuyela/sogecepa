...
@section('titulo', 'Corredor do Lobito')
@section('content')
            ...
            <div class="financity-page-title-wrap  financity-style-custom financity-left-align">
                ...
                <div class="financity-page-title-container financity-container">
                    <div class="financity-page-title-content financity-item-pdlr">
                        <h1 class="financity-page-title">Corredor do Lobito</h1>
                    ...
                    <div class="gdlr-core-pbf-element">
                        <div class="gdlr-core-breadcrumbs-item gdlr-core-item-pdlr gdlr-core-item-pdb "> <span
                                ...
                                <meta property="position" content="1">
                                    ...
                                    href="{{ route('site.lobitoCorridor') }}" class="post post-page"><span
                                        property="name">Corredor do Lobito</span></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-8 col-12 container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid rounded" src="/site/assets/upload/Corredor_do_Lobito-01.jpg"
                                    alt="">
                            ...
                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid rounded" src="/site/assets/upload/Corredor_do_Lobito-02.jpg"
                                    alt="">

                            </div>

                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid rounded" src="/site/assets/upload/Corredor_do_Lobito-03.jpg"
                                    alt="">

                            </div>

                            <div class="col-md-6 col-12 p-2">
                                <img class="img-fluid rounded" src="/site/assets/upload/Corredor_do_Lobito-04.jpg"
                                    alt="">
