                        ...
                        <div class="gdlr-core-breadcrumbs-item gdlr-core-item-pdlr gdlr-core-item-pdb "> <span
                                ...
                                <meta property="position" content="1">
                                    ...
                                    href="{{ route('site.contact') }}" class="post post-page"><span
                                        property="name">Contactos</span></a>
                            ...
                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js"
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-icon-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align"
                                        style="padding-bottom: 45px;"><i class=" gdlr-core-icon-item-icon fa fa-phone"
                    ...
                    <div class="gdlr-core-pbf-column gdlr-core-column-20">
                        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="padding: 50px 20px 0px 20px;">
                            <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js"
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-icon-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align"
                                        style="padding-bottom:  45px;"><i class=" gdlr-core-icon-item-icon fa fa-envelope-o"
                                            style="color: #454545;font-size: 40px;min-width: 40px;min-height: 40px;"></i>
                                    </div>
                                </div>
                                <div class="gdlr-core-pbf-element">
                                ...
                                <div class="gdlr-core-pbf-element">
                                    <div
                                        ...
                                        <div class="gdlr-core-title-item-title-wrap ">
                                            ...
                                            style="font-style: normal;">ENTRE EM CONTACTO CONOSCO</span>
                                    </div>
                                </div>
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-divider-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-divider-item-normal"
                                        ...
                                        <div class="gdlr-core-divider-container gdlr-core-center-align"
                                            ...
                                            <div class="gdlr-core-divider-line gdlr-core-skin-divider"
                                                style="border-color: #2b2b2b;border-bottom-width: 2px;"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="gdlr-core-pbf-element">
                                    <div class="gdlr-core-contact-form-7-item gdlr-core-item-pdlr gdlr-core-item-pdb ">
                                        <div role="form" class="wpcf7" id="wpcf7-f1319-p1964-o1" lang="en-US"
                                            dir="ltr">
                                            ...
                                            <form class="quform" action="quform/process.php" method="post"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-12">
                                                        <input type="text" class="form-control bg-white rounded "
                                                            placeholder="Nome">
                                                    </div>
                                                    <div class="col-md-6 col-12">
                                                        <input type="email" class="form-control bg-white rounded "
                                                            placeholder="Email">
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12 mx-auto">
                                                        <a href="#" style="background: #ffb400;"
                                                            class="btn btn-sm  w-100 text-dark">Enviar</a>
                                                    </div>
                                                </div>
                    ...
                    <div class="gdlr-core-pbf-element">
                        <div
                            ...
                            <a href="mailto:#" target="_blank" class="gdlr-core-social-network-icon" title="email"
                                ...
                                href="#" target="_blank" class="gdlr-core-social-network-icon" title="facebook"
